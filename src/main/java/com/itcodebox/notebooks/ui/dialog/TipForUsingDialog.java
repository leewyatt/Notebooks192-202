...
public class TipForUsingDialog extends DialogWrapper {
    ...
    private final Tip[] tips = new Tip[]{
            //new Tip("Update or installation issues",
            //        new String[]{
            //                "近期不知何故,更新时会出现插件消失的情况,已经开始联系IDEA官方",
            //                "解决方案: 更新后插件消失, 再次安装即可;也可以先卸载然后再安装;<br/>Notebook的用户数据不会丢失;",
            //                "Recently, the plug-in will disappear during the update,<br/> and I have begun to contact the IDEA official;",
            //                "Solution: After the update, the plug-in disappears, just install it again;<br/> you can also uninstall and then install it<br/>Notebook user data will not be lost;"
            //        },
            //        null
            //),
            //联系方式
