...
public  class BaseNoteDialog extends DialogWrapper {
    ...
    private void initControls() {
        ...
        comboBoxNotebookTitle.addItemListener(e -> {
            ...
            CustomUIUtil.addAll(chapterTitleModel,chapterService.getTitles(notebook.getTitle()));
        ...
        comboBoxChapterTitle.addItemListener(e -> {
            ...
            CustomUIUtil.addAll(noteTitleModel,noteService.getTitles(notebook.getTitle(), chapter.getTitle()));
            noteTitleModel.setSelectedItem(noteTitle);
        });
    ...
    public void fillData() {
        ...
        CustomUIUtil.addAll(notebookTitleModel,notebookService.getTitles());
        //List<String> titles = notebookService.getTitles();
        //for (String title : titles) {
        //    notebookTitleModel.addElement(title);
        //}
        final ProjectStorage projectStorage = ServiceManager.getService(project,ProjectStorage.class);
